...
NARRATIONS = [
    ...
    "削減効果です。年間の電気代削減は現状でAプラン277万円からBプラン322万円、満床時には408万円から558万円まで広がり、投資回収は満床達成で4年台に短縮します。施設部の窓コーティングも、工事費約97万円に補助金2分の1を活用すれば自己負担は約49万円、年間約16万円の削減で、単体でおよそ3年で回収できる見込みです。20年間の累計では最大で約8700万円の効果が見込めます。",
